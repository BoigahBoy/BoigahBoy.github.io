		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							<div class="logo"><span class="icon fa-arrow-alt-circle-down"></span></div>
							<h2>My Portfolio</h2>
							<p>A showcase of my abilities and contributations.</p>
						</div>
					</section>
					...
					<section id="footer">
						<div class="inner">
							<ul class="contact">
								...
								<li class="icon brands fa-linkedin"><a href="https://www.linkedin.com/in/zackerybaker-it/">linkedin.com/in/zackerybaker-it/</a></li>
							</ul>
							<ul class="copyright">
